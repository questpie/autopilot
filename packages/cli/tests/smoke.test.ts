...
import { TaskService, RunService, WorkerService, EnrollmentService, WorkflowEngine, ActivityService, ArtifactService, ConversationBindingService, QueryService } from '../../orchestrator/src/services'
...
describe('CLI smoke: full lifecycle via API', () => {
	...
	beforeAll(async () => {
		...
		services = { taskService, runService, workerService, enrollmentService, activityService, artifactService, conversationBindingService, queryService, workflowEngine }
