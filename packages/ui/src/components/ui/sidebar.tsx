...
import {
	...
	SheetHeader,
	SheetTitle,
} from "@questpie/ui/components/ui/sheet";
			...
			<Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
				...
				>
					<SheetHeader className="sr-only">
						...
						<SheetDescription>Zobrazuje mobilnú navigáciu.</SheetDescription>
					</SheetHeader>
...
function SidebarRail({
	className,
	"aria-label": label = "Prepnúť bočný panel",
	title = label,
	...props
