...
export function TopBar() {
  ...
  return (
    <header className="flex h-12 shrink-0 items-center border-b border-border bg-background px-4 font-heading">
      ...
      <Link
        to="/settings"
        className="mr-1 hidden min-h-[44px] min-w-[44px] items-center justify-center text-muted-foreground transition-colors hover:text-foreground sm:flex"
      ...
      <div className="relative">
        <button
          type="button"
          className="group relative flex min-h-[44px] min-w-[44px] items-center justify-center gap-2 text-muted-foreground transition-colors hover:text-foreground"
