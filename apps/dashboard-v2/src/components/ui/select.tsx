			...
			{!props.hideCaret && (
				<SelectPrimitive.Icon
					render={
						<CaretDownIcon
							className={cn(
								'pointer-events-none text-muted-foreground transition-transform duration-150 ease-out group-data-open:rotate-180',
	...
	return (
		...
		>
			...
			<SelectPrimitive.ItemIndicator
				render={
					<span className="pointer-events-none absolute right-2 flex size-4 items-center justify-center animate-check-scale-in motion-reduce:animate-none" />
				}
			>
