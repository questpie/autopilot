...
export type AppRoutes = _ModuleRoutes & {
	...
	"channels/archive": RouteWithParams<_RouteDefinitionWithoutHandler<typeof _route_channels_archive>, RouteParamsFromKey<"channels/archive">>;
	"channels/create": RouteWithParams<_RouteDefinitionWithoutHandler<typeof _route_channels_create>, RouteParamsFromKey<"channels/create">>;
	"channels/rename": RouteWithParams<_RouteDefinitionWithoutHandler<typeof _route_channels_rename>, RouteParamsFromKey<"channels/rename">>;
	"channels/restore": RouteWithParams<_RouteDefinitionWithoutHandler<typeof _route_channels_restore>, RouteParamsFromKey<"channels/restore">>;
