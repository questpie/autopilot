...
const TIPTAP_CONTENT_CLASSNAME = cn(
  ...
  '[&_.ProseMirror>*+*]:mt-4',
  '[&_.ProseMirror_h1]:mt-8 [&_.ProseMirror_h1]:mb-3 [&_.ProseMirror_h1]:text-[28px] [&_.ProseMirror_h1]:font-semibold [&_.ProseMirror_h1]:tracking-[-0.02em] [&_.ProseMirror_h1]:text-foreground',
  '[&_.ProseMirror_h2]:mt-7 [&_.ProseMirror_h2]:mb-3 [&_.ProseMirror_h2]:text-[22px] [&_.ProseMirror_h2]:font-semibold [&_.ProseMirror_h2]:tracking-[-0.02em] [&_.ProseMirror_h2]:text-foreground',
  '[&_.ProseMirror_h3]:mt-6 [&_.ProseMirror_h3]:mb-2 [&_.ProseMirror_h3]:text-[18px] [&_.ProseMirror_h3]:font-semibold [&_.ProseMirror_h3]:text-foreground',
  '[&_.ProseMirror_p]:my-0 [&_.ProseMirror_p]:text-foreground',
...
function resolveSlashMenuState(editor: Editor, view: EditorView | null): Omit<SlashMenuState, 'activeIndex'> | null {
  if (!view) return null
...
export function TiptapEditor({
  ...
  return (
    <div className={cn('relative w-full', className)} onClick={handleClick}>
      <EditorContent
        editor={editor}
        className={cn(TIPTAP_CONTENT_CLASSNAME, contentClassName)}
      />
