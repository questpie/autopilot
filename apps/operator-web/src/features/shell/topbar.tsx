...
export function Topbar({ onSearchOpen }: TopbarProps) {
	...
	return (
		<header className="sticky top-0 z-50 flex h-12 shrink-0 items-center  px-3">
			...
			<div className="flex items-center gap-2">
				...
				<DropdownMenu>
					<DropdownMenuTrigger
						render={
							<button className="flex size-7 items-center justify-center bg-muted font-mono text-[11px] font-medium text-foreground transition-colors hover:bg-accent">
								{initials}
							</button>
						}
					/>
