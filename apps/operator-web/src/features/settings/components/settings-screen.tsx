...
function AppPreferencesTab() {
	const { theme, setTheme, locale, setLocale, developerMode, setDeveloperMode } =
		useAppPreferences()
		...
		<div className="space-y-6">
			...
			<SettingsSection title="About">
				<SettingRow
					label="Version"
					control={
						<span className="font-mono text-xs text-muted-foreground">QUESTPIE Autopilot v2</span>
					}
				/>
			</SettingsSection>
		</div>
...
export function SettingsScreen() {
	...
	const canManageConfig = canManageUsers
	...
	return (
		<div className="space-y-5">
			...
			<div>
				...
				<p className="mt-1 text-sm text-muted-foreground">
					Profile, security, application preferences, and operator configuration
				</p>
			</div>
			...
			>
				<TabsList>
					...
					{canManageConfig && <TabsTrigger value="config">Configuration</TabsTrigger>}
					{canManageConfig && <TabsTrigger value="projects">Projects</TabsTrigger>}
				</TabsList>
