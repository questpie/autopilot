...
- **Authentication** (choose one):
  - `autopilot provider set openrouter --api-key sk-or-...` -- use your Claude Max/Pro subscription (recommended)
  - `OPENROUTER_API_KEY` -- API key from [openrouter.ai/keys](https://openrouter.ai/keys) (alternative)
