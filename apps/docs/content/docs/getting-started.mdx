...
agents:
  - id: ceo
    ...
    tools: ["create_task", "update_task", "send_message", "ask_agent", "pin_to_board"]
  ...
  - id: max
    ...
    tools: ["create_task", "update_task", "send_message", "create_artifact", "skill_request", "search"]
```
...
- [Primitives](/docs/primitives) -- the 14 structured primitives agents use (the core differentiator)
