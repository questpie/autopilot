...
Agents don't generate text. They call 12 unified tools that produce visible, auditable effects: `task`, `message`, `pin`, `search_index`, `fetch`, `web_search`, and more. Agent thinking is private. Only effects are visible. This is the core architectural differentiator. See [Tools](/docs/primitives).
