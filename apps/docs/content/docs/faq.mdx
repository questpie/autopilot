...
On the worker machine. Never centralized. The orchestrator stores operational state and authored config, but credentials, API keys, and runtime secrets stay on the machine that needs them.
