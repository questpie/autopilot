...
Yes. Operator Web is the active dashboard/home, chat, tasks, and Knowledge surface. The system remains fully operable through the CLI, notifications, and conversation bindings because all clients use the same orchestrator primitives.
