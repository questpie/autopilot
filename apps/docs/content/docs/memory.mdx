...
description: 4-layer context assembly, persistent agent memory, memory extraction after sessions, and cross-session knowledge retention.
---

How agents remember, learn, and maintain awareness across sessions. 4-layer context assembly. Persistent memory extraction. Role-scoped isolation.
...
Before every agent session, the Context Assembler builds a system prompt from four sources.
