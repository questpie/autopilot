...
description: The core differentiator. Agents call 12 unified tools that produce visible, auditable effects. No text generation. No chat. Structured execution.
---
