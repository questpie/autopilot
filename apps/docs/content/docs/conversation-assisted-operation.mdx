...
That is enough to prove the async operator loop without making a separate Worker App architecture.

## Real example: Telegram

The [Telegram surface pack](/docs/telegram-surface) is the first real implementation of conversation-assisted operation. It demonstrates:
...
- [Telegram Surface](/docs/telegram-surface)
