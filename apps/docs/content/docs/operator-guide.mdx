...
description: "Day-to-day operation: tasks, attention, approvals, previews, and the CLI."
---
...
No separate Worker App is required. The CLI exposes the full operator loop today, and Operator Web should compose the same primitives.
