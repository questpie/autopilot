...
Out of the box, Autopilot runs with **authentication disabled**. This is intentional — a local single-user instance should be frictionless. All requests are treated as the owner with full permissions.

When you expose your instance to a team or the internet, you enable authentication and configure access control. The security model is layered:
